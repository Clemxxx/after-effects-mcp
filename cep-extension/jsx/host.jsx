...
function processCommandFile(file) {
  ...
  // Execute the script.
  // NOTE: no undo group here — mutating scripts generated by the MCP server
  // already wrap themselves in their own named undo group (wrapInUndoGroup).
  // Opening a second, nested group at this level corrupts AE's undo stack:
  // successive operations end up merged into one giant undo entry and
  // keyboard shortcuts (Ctrl+Z / Ctrl+S) start misbehaving.
  var result;
  try {
